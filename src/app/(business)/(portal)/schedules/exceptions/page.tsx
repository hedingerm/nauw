...
export default function ScheduleExceptionsPage() {
  ...
  const handleCreateException = (employeeId?: string) => {
  ...
  const handleAddHolidayForAll = () => {
    // Open dialog with holiday preset
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            onClick={handleAddHolidayForAll}
          >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline">{filteredExceptions.length} Ergebnisse</Badge>
          </div>
